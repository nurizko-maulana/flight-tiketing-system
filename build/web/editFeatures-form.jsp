...
<html>
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
                     ...
                     <a href="homepage_manager.jsp" class="list-group-item list-group-item-action bg-light">Home</a>
 ...
 <div class="form-group">
  <label >Seat Category</label>
    <select class="form-control" name="seatCat">
      <option selected><c:out value='${features.seatCat}'/></option>
 ...
 <div class="form-group">
  <label >Seat Width</label>
    <select class="form-control" name="seatWidth">
      <option selected><c:out value='${features.seatWidth}'/></option>
 ...
 <div class="form-group">
  <label >Seat Type</label>
    <select class="form-control" name="seatType">
      <option selected><c:out value='${features.seatType}'/></option>
  ...
  <label >Video Type</label>
    <select class="form-control" name="videoType">
      <option selected><c:out value='${features.videoType}'/></option>
  ...
  <label >Power Type</label>
    <select class="form-control" name="powerType">
      <option selected><c:out value='${features.powerType}'/></option>
  ...
  <label >Wifi</label>
    <select class="form-control" name="wifi">
      <option selected><c:out value='${features.wifi}'/></option>
