...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <a href="scheduleServlet?action=APPROVE&id=${schedule.id}" class="btn btn-warning">Approve</a>  <a href="scheduleServlet?action=REJECT&id=${schedule.id}" class="btn btn-danger">Reject</a> </td>
    </tr>
     </c:forEach>
  </tbody>
</table>
