<%-- 
    Document   : adminUserTransaction
    Created on : Feb 4, 2021, 6:26:57 AM
    Author     : Asus
--%>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="Planes?action=VIEW" class="list-group-item list-group-item-action bg-light">Plane</a>
                    <a href="transaction?action=VIEW" class="list-group-item list-group-item-action bg-primary active">User Transaction</a>
